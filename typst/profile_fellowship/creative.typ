...
#block(above: 4pt, below: 2pt)[
  ...
  bullets: (
    [_Sujeto/Yo_ (2025): a self-portrait series of ten photographs on a single roll of 120 film, taken on a single midnight. Each frame carries three titles, in Spanish, English, and French, titles rather than translations, with a short poetic text; the gaze turned, for once, on myself.],
  ),
)
