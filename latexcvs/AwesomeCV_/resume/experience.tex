...
\begin{cventries}
    ...
    \cventry
        ...
        {
            \begin{cvitems}
            \item {Collaborated in the questionnaires applications and data capturing in the project \hrefi{https://estudiosdemograficosyurbanos.colmex.mx/index.php/edu/article/view/1791/pdf}{Mexican parents’ attitudes toward gender equality in family roles and leadership.}
            \end{cvitems}
        }
\end{cventries}
\vspace{-3.2mm}
